...
// Function prototypes
void load_data(vector<int>& t, vector<double>& x, vector<double>& y, string filename);
void compute_norm(vector<double>& x, vector<double>& y,vector<double>& norm);
void compute_move_ave(vector<int>& t, vector<double>& norm, vector<double>& move_ave, vector<double>& time_ave, int n_sum);
int output_file(const vector<double>& move_ave, const vector<double>& time_ave, string filename_out);

// Main function that takes in the command line arguments
